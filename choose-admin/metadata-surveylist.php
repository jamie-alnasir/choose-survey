...
<font size="1">
<ul id="sddm">
    <li><a href='http://www.surveymonkey.com/' target='_surveymonkeyframe'>New survey</a></li>
</ul>
</font>
<br><br>

<form action="metadata-setsurveyvis.php" method="POST">
<?php

echo $SurveyApp->getSurveyListAdmin(false);
echo "<br>";
echo "<input type='submit' value='update/set visibility'>";
