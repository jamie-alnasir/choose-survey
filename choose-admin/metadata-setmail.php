...
// Get params
$Contact_email = htmlspecialchars($_GET["contact_eml"]);

if ($SurveyApp->updateGlobalParam('contact_email', $Contact_email) == 0)
{
        echo "<b>All contact messages will now be sent to (" . $Contact_email . "), this has been updated in the RHUL metadata!</b><br><br>";
