...
// Get params
$Survey_ID = htmlspecialchars($_GET["srv_id"]);

if ($SurveyApp->deleteSurveyResponses($Survey_ID) == 0)
{
        echo "<b>ALL Survey response for this survey now deleted from the RHUL metadata!</b><br><br>";
        echo "Take me <b><a class='btn' href='" . $Admin_Home . "/metadata.php'>Back</a></b>";
} else
{
        echo "<b>Failed to remove the response metadata! - Consult a systems admin or programmer!</b>";
}
